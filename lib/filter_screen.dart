...
import 'package:hotel_booking/models/popular_list_data.dart';
import 'package:hotel_booking/range_slider_view.dart';
import 'package:hotel_booking/slider_view.dart';
          ...
          child: InkWell(
            ...
            child: Padding(
              ...
              child: Row(
                children: <Widget>[
                  Expanded(
                    child: Text(date.titleTxt, style: TextStyle(color: Colors.black)),
                  ),
                  CupertinoSwitch(
            ...
            Container(
              ...
              child: Material(
                ...
                child: InkWell(
                  ...
                  child: Padding(padding: const EdgeInsets.all(8.0), child: Icon(Icons.close)),
                ),
              ),
            ),
            Expanded(
