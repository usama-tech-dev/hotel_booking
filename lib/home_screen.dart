...
import 'package:hotel_booking/calendar_pop_up_view.dart';
import 'package:hotel_booking/hotel_app_theme.dart';
import 'package:hotel_booking/hotel_list_view.dart';
      ...
      child: Row(
        children: <Widget>[
          ...
          Padding(
            ...
            child: Container(width: 1, height: 42, color: Colors.grey.withOpacity(0.8)),
          ),
          Expanded(
            child: Row(
              children: <Widget>[
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(border: InputBorder.none, hintText: 'London...'),
                  ),
                ),
              ),
            ),
      ...
      child: Padding(
        ...
        child: Row(
          children: <Widget>[
            ...
            Expanded(
              child: Center(
                child: Text('Explore', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 22)),
              ),
            ),
            Container(
              width: AppBar().preferredSize.height + 40,
